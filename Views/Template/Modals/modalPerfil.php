            ...
            <form id="formPerfil" name="formPerfil" class="form-horizontal">
             ...
             <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <input type="password" class="form-control" minlength="8" id="txtPassword" name="txtPassword" >
                </div>
                <div class="form-group col-md-6">
                  <label for="txtPasswordConfirm">Confirmar Password</label>
                  <input type="password" class="form-control" minlength="8" id="txtPasswordConfirm" name="txtPasswordConfirm" >
                </div>
             </div>
