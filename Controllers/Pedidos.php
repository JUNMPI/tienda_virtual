...
class Pedidos extends Controllers{
	...
	public function Pedidos()
	{
		...
		$data['page_title'] = "PEDIDOS <small> Facherito Shop</small>";
	...
	public function orden($idpedido){
		...
		$data['page_tag'] = "Pedido - Facherito Shop";
		$data['page_title'] = "PEDIDO <small>Facherito Shop</small>";
	...
	public function transaccion($transaccion){
		...
		$data['page_tag'] = "Detalles de la transacción - Facherito Shop";
